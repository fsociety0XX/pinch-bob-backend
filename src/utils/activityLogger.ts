...
export const ActivityActions = {
  ...
  UPDATE_CUSTOMISE_CAKE: 'UPDATE_CUSTOMISE_CAKE',
  ADD_CUSTOMISE_CAKE_REF_IMAGES: 'ADD_CUSTOMISE_CAKE_REF_IMAGES',
  REMOVE_CUSTOMISE_CAKE_REF_IMAGE: 'REMOVE_CUSTOMISE_CAKE_REF_IMAGE',
