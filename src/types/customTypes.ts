...
export const customiseOrderEnums = {
  ...
  baseSponge: ['Chocolate', 'Vanilla', 'Pandan'],
  colourCode: [
    'Black & Grey (All black)',
    'Deep/Midnight Blue (All dark blue)',
    'Green (All green)',
    'Orange (All orange)',
    'Pastel Blue, Teal, Blue, Midnight Blue, Paddlepop (All blue)',
    'Pink, Coral (All pink)',
    'Purple, Lilac, Violet (All purple)',
    'Red, Burgundy (All red)',
    'Solid Rainbow, Pastel Rainbow, Multi Colour - more than 3 colours (Multicolour)',
    'Yellow, Gold, Ivory, Brown (All yellow)',
    'N/A',
  ],
